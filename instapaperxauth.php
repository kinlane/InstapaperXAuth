...
/* Load OAuth lib - Available at http://oauth.net */
...
class InstapaperXAuth {
  ...
  public $host = "https://www.instapaper.com/api/1/";
  /* Set timeout default. */
  public $timeout = 30;
  /* Set connect timeout. */
  ...
  public $http_info;
  /* Set the user agent. */
  public $useragent = 'InstapaperXAuth v0.1.0';

  /**
   * Set API URLS
   */
  function accessTokenURL()  { return 'https://www.instapaper.com/api/1/oauth/access_token'; }
  function bookmarksList()  { return 'https://www.instapaper.com/api/1/bookmarks/list'; }
  function bookmarksGetText()  { return 'https://www.instapaper.com/api/1/bookmarks/get_text'; }
  ...
  /**
   * construct InstapaperXAuth object
   */
